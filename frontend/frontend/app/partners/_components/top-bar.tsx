...
export const Nav = () => {
    ...
    return (
            ...
            <nav className="flex w-full justify-between items-center py-3 lg:py-[22.5px] relative">
                ...
                <Link
                    href={"/"}
                    className="rounded flex items-center w-max gap-2.5 border hover:bg-transparent active:bg-transparent h-auto px-10 py-2 text-[15px] font-medium whitespace-nowrap border-[#FF0065] bg-[#0A0A0B]  text-[#F8F8F8]"
                >
                    Explore
                </Link>
            </nav>
