...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        {/* <Icon.accordionClose className="shrink-0 transition-all duration-200 [[data-state=closed]_&]:hidden" /> */}
        {/* <Icon.accordionOpen className="shrink-0 transition-all duration-200 [[data-state=open]_&]:hidden" /> */}
      </AccordionPrimitive.Trigger>
